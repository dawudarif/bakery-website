...
const Featured = () => {
  return (
    <div className="flex h-max w-[100%] flex-col flex-wrap items-center justify-center bg-yellow-600 p-10 px-0">
        ...
        {imagesArray.map((image) => (
          ...
          >
            <img
              alt={image.name}
              src={image.url}
              className="rounded-md bg-cover lg:h-[30rem] lg:w-[30rem]"
            />
